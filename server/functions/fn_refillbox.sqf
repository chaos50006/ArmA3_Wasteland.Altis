...
switch (_boxType) do
{
	...
	case "mission_USSpecial":
	{
		...
		[
			...
			["wep", ["arifle_MXM_F", "srifle_EBR_F", "srifle_DMR_01_DMS_F", "srifle_DMR_03_multicam_F"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(4,6)],
			["wep", ["LMG_Mk200_F", "LMG_Zafir_F", "MMG_02_black_F", "MMG_01_tan_F"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(2,4)],
	...
	case "mission_Main_A3snipers":
	{
		...
		[
			// Item type, Item class(es), # of items, # of magazines per weapon
			["wep", ["srifle_LRR_LRPS_F", "srifle_GM6_camo_LRPS_F", "srifle_DMR_02_camo_F", "srifle_DMR_05_blk_F", "srifle_DMR_04_F"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(4,6)],
			["wep", ["srifle_EBR_F", "srifle_DMR_01_F", "srifle_DMR_03_multicam_F", "srifle_DMR_06_camo_F"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(4,6)],
