...
while {true} do
{
	...
	_serverString = format ["<t color='#A0FFFFFF'>Server: HMGT A3Wasteland Altis</t>", call A3W_extDB_ServerID];
	_serverString = format ["%1<br/><t color='#A0FFFFFF'>Teamspeak: howlingmaggots.com<br/>Website: www.howlingmaggots.com</t>",_serverString];
